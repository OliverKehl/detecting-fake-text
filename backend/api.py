...
class BERTLM(AbstractLanguageChecker):
    #def __init__(self, model_name_or_path="/Users/kangjihua/Documents/chinese_L-12_H-768_A-12"):  # "bert-base-chinese"):
    def __init__(self,
                 model_name_or_path="/Users/kangjihua/Documents/chinese_L-12_H-768_A-12"):
...
def main():
    ...
    In a shocking finding, scientist discovered a herd of unicorns living in a remote, previously unexplored valley, in the Andes Mountains. Even more surprising to the researchers was the fact that the unicorns spoke perfect English.
    """
    raw_text = u'4月23日，中国海军将迎来70周岁生日，当天在青岛及其附近海空域将举行各国海军舰艇海上阅兵，除中方参阅兵力外，俄罗斯、泰国、越南、印度等10多个国家近20艘舰艇将参加检阅活动。'
